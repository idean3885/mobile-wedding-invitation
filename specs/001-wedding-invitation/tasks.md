...
- [x] T002 `@sveltejs/adapter-static` 설치 및 `svelte.config.js` 설정 (prerender: entries: ['/'], precompress: true)
...
- [ ] T020 [US4] 지도 연동: 네이버 지도/카카오 지도 링크 설정 — 남부터미널 더화이트베일 (별도 태스크로 본격 작업)
